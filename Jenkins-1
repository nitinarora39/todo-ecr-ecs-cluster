pipeline {
    ...
    stages {
        ...
        stage('Deploy on Elastic Container Service') {
            steps {
                 // sh 'aws ecs create-cluster --cluster-name to-do-app'
                 ...
                 // sh 'aws ecs create-service --cluster to-do-app --service-name to-do-app-service --task-definition to-do-app --desired-count 1 --launch-type "FARGATE" --network-configuration "awsvpcConfiguration={subnets=[subnet-096fbbb07ea94167a],securityGroups=[sg-092e1df1dcb09964a],assignPublicIp=ENABLED}"'
